...
class PlayState extends MusicBeatState
{
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingString == '?') {
			scoreTxt.text = 'Your Score: ' + songScore + ' | ComboBreaks: ' + songMisses + ' | Accuracy: ' + ratingString;
		} else {
			scoreTxt.text = 'Your Score: ' + songScore + ' | ComboBreaks: ' + songMisses + ' | Accuracy: ' + ratingString + ' (' + Math.floor(ratingPercent * 100) + '%)';
		}
